...
All files saved under **`/mnt/d/Opencode/{project-name}/`** (create the directory if it doesn't exist).
...
2. Create output directory: `mkdir -p "/mnt/d/Opencode/{project-name}"`
...
9. Save output to `/mnt/d/Opencode/{project-name}/scanner-output.json`
